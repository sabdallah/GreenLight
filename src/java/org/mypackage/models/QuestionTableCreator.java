     ...
     public QuestionTableCreator(PrintWriter out, int room) {
        ...
        if (questions == null) {
            ...
            while (index < questions.length) {
                ...
                out.print("<tr>\n"
                        + "<td>" + question +"</td>\n"
                        + "<td>" + "<input src=\"http://files.softicons.com/download/web-icons/minicons-numbers-icons-by-icojam/png/16x16/red/065.png\" id=\"Delete\" type=\"button\" value=\"\" onclick=\"deleteQuestion(" + index + ");\" />" + "</td>\n"
                        + "<td>" + "<input src=\"http://findicons.com/files/icons/2564/max_mini_icon/16/flag_red.png\" id=\"Delete\" type=\"button\" value=\"\" onclick=\"deleteQuestion(" + index + ");\" />" + "</td>\n"
                        + "</tr>");
                index++;
            }
        }
